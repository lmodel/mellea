...
# description: LinkML schema describing the Mellea codebase architecture and public data models. Generated from
#              Python sources by linkml/scripts/schema_to_linkml.py.
# license: Apache-2.0
...
class BiolinkNameSpace:
    ...
    _namespaces = [
        ...
        CurieNamespace('mellea', 'https://w3id.org/lmodel/mellea/'),
        CurieNamespace('nexus', 'https://ibm.github.io/ai-atlas-nexus/ontology/'),
        CurieNamespace('schema', 'http://schema.org/'),
        CurieNamespace('spdx', 'https://spdx.org/rdf/3.0.1/terms/'),
